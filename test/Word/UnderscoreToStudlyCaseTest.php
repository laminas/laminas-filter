...
class UnderscoreToStudlyCaseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFiltersArray()
    {
        ...
        $string   = array('laminas_framework', '_laminas_framework');
        $filtered = $filter($string);
        $this->assertNotEquals($string, $filtered);
        $this->assertEquals(array('laminasFramework', 'laminasFramework'), $filtered);
    }
    ...
    public function testWithEmpties()
    {
        ...
        $string   = array('', 'Laminas_Framework');
        $filtered = $filter($string);
        $this->assertEquals(array('', 'laminasFramework'), $filtered);
    }
}
